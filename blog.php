...
<head>
    ...
    <!-- Tilte -->
    <title> Blog and News || Agep international || Agep Design Solutions || Agep India || Agep Coating || Agep Thailand
    </title>
    <!-- Favicons -->
    <link href="assets/img/fevicon.ico" rel="icon">
    <link href="assets/img/fevicon.ico" rel="apple-touch-icon">
    <!-- Vendor CSS Files -->
...
<main id="main">
    <!-- ======= main header section  ======= -->
    <section id="visionmission" class="visionmission mt-5">
        ...
        <div class="container" data-aos="fade-up">
            <div class="row">
                <div class="col-lg-8 entries">
                    <article class="entry">
                        <div class="entry-img">
                            <img src="assets/img/Websitebanners.svg" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="assets/img/Website banners 2.svg" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        <div class="entry-img">
                            <img src="assets/img/Website banners 1.svg" alt="" class="img-fluid">
                        </div>
                        <h2 class="entry-title">

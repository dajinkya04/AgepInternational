...
<p>Welcome to www.agepinternational.com!</p>

<p>These terms and conditions outline the rules and regulations for the use of AGEP International 's Website, located at
    www.agepinternational.com.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
    www.agepinternational.com if you do not agree to take all of the terms and conditions stated on this page.</p>
...
<p>We employ the use of cookies. By accessing www.agepinternational.com, you agreed to use cookies in agreement with the
    AGEP International 's Privacy Policy. </p>
...
<p>Unless otherwise stated, AGEP International and/or its licensors own the intellectual property rights for all
    material on www.agepinternational.com. All intellectual property rights are reserved. You may access this from
    www.agepinternational.com for your own personal use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from www.agepinternational.com</li>
    <li>Sell, rent or sub-license material from www.agepinternational.com</li>
    <li>Reproduce, duplicate or copy material from www.agepinternational.com</li>
    <li>Redistribute content from www.agepinternational.com</li>
</ul>
...
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
    of the website. AGEP International does not filter, edit, publish or review Comments prior to their presence on the
    website. Comments do not reflect the views and opinions of AGEP International ,its agents and/or affiliates.
    Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
    applicable laws, AGEP International shall not be liable for the Comments or for any liability, damages or expenses
    caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
    website.</p>

<p>AGEP International reserves the right to monitor all Comments and to remove any Comments which can be considered
...
<p>You hereby grant AGEP International a non-exclusive license to use, reproduce, edit and authorize others to use,
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of AGEP International ;
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to AGEP International . Please include your name, your organization name,
...
<p>No use of AGEP International 's logo or other artwork will be allowed for linking absent a trademark license
    agreement.</p>
